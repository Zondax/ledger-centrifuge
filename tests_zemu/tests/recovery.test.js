...
describe('Standard', function () {
    test.each(models)('main secret menu (%s)', async function (_, {model, prefix, path}) {
        ...
        try {
            ...
            const centrifuge_expected_address = "JMdbWK5cy3Bm4oCyhWNLQJoC4cczNgJsyk7nLZHMqFT7z7R";
            const centrifuge_expected_pk = "ffbc10f71d63e0da1b9e7ee2eb4037466551dc32b9d4641aafd73a65970fae42";
